...
public class RotatingLog extends Log {
     ...
     */
    synchronized public Log print(String message, int level) {  //long now=GregorianCalendar.getInstance().getTime().getTime();
     ...
     */
    private void updateNextRotationTime() {  //Calendar cal=GregorianCalendar.getInstance();
