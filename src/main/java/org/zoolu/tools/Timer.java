...
public class Timer extends MonitoredObject implements InnerTimerListener {
     ...
     * Inits the Timer.
     */
    void init(long time, String label, TimerListener listener) {  //listener_list=new HashSet();
   ...
   {  listener_list.remove(listener);
     ...
     */
    public synchronized void onInnerTimeout() {  //if (active && !listener_list.isEmpty())
