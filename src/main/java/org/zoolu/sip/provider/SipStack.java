...
public class SipStack extends Configure {
    ...
    protected void parseLine(String line) {
        ...
        if (attribute.equals("default_tls_port")) {
            default_tls_port = par.getInt();
            return;
        }
        ...
        if (attribute.equals("auto_trying")) {
            auto_trying = (par.getString().toLowerCase().startsWith("y"));
            return;
        }
        ...
        // registration client configurations
        if (attribute.equals("regc_min_attempt_timeout")) {
            regc_min_attempt_timeout = par.getInt();
            return;
        }
        if (attribute.equals("regc_max_attempt_timeout")) {
            regc_max_attempt_timeout = par.getInt();
            return;
        }
        if (attribute.equals("regc_auth_attempts")) {
            regc_auth_attempts = par.getInt();
            return;
        }
        ...
        // extensions
        if (attribute.equals("on_dialog_route")) {
            on_dialog_route = (par.getString().toLowerCase().startsWith("y"));
            return;
        }
        if (attribute.equals("alternative_transaction_id")) {
            alternative_transaction_id = (par.getString().toLowerCase().startsWith("y"));
            return;
        }
