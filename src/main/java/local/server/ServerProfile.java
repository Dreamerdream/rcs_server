...
public class ServerProfile extends Configure {
     ...
     */
    public String location_db = "config/users.db";
    /**
     ...
     */
    public String authentication_db = "config/aaa.db";
     ...
     */
    public ServerProfile(String file) {  // load SipStack first
        ...
        //authenticated_phone_proxying_rules:new ProxyingRule[0] 这里看不懂
